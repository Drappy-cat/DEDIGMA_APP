  ...
  return (
    ...
    >
      <img
        ...
        alt="Dimas Mascot"
        className={`${sizeClasses[size]} object-contain filter drop-shadow-md ${isLobby ? "scale-[1.25] origin-bottom" : ""}`}
      />
      <img 
...
export const MascotGita: React.FC<MascotProps> = ({ size = "md", animate = true, isLobby = false }) => {
  ...
  return (
    ...
    >
      ...
      <span className={
        isLobby
          ? "absolute -bottom-2 text-[12px] font-['Fredoka'] font-bold text-amber-700 bg-amber-100 px-3 py-1 rounded-full shadow-sm z-10 pointer-events-none"
